  ...
  const filteredAssessments = classAssessmentsData
    .filter((assessment) => {
      ...
      if (activeTab === 'upcoming')
        return assessment.status === 'Upcoming' && matchesSearch
      if (activeTab === 'active')
        return assessment.status === 'Active' && matchesSearch
      if (activeTab === 'grading')
        return assessment.status === 'Grading' && matchesSearch
      if (activeTab === 'completed')
        return assessment.status === 'Completed' && matchesSearch
    ...
    <div className="p-6 max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-800">
              {classData.name} - Assessments
            </h1>
            <p className="text-gray-600">
              {classData.grade} • Room {classData.room} •{' '}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <div className="bg-white rounded-lg shadow p-6 border border-gray-200">
          <div className="flex justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-800">
                {classStatistics.overallAverage}%
              </p>
            </div>
          ...
          <div className="mt-4">
            {Object.entries(classStatistics.subjectAverages).map(
              ([subject, avg]) => (
                <div
                  key={subject}
        ...
        <div className="bg-white rounded-lg shadow p-6 border border-gray-200">
          <div className="flex justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-800">
                {classStatistics.completionRate}%
              </p>
            </div>
          ...
          <div className="mt-4">
            ...
            <div className="mt-2 text-xs text-gray-600">
              {classAssessmentsData.reduce(
                (sum, curr) => sum + curr.studentsCompleted,
                0,
              )}{' '}
              out of{' '}
              {classAssessmentsData.reduce(
                (sum, curr) => sum + curr.studentsTotal,
                0,
              )}{' '}
              total submissions
            </div>
        ...
        <div className="bg-white rounded-lg shadow p-6 border border-gray-200">
          <div className="flex justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-800">
                {classStatistics.topPerformingStudents.length +
                  classStatistics.needsAttention.length}
          ...
          <div className="mt-4">
            ...
            {classStatistics.topPerformingStudents
              .slice(0, 2)
              .map((student) => (
                <div
                  key={student.id}
            ...
            <div className="text-xs font-medium text-red-700 mt-2 mb-1">
              Needs Attention
            </div>
      ...
      <div className="bg-white rounded-lg shadow border border-gray-200 mb-6">
        ...
        <div className="px-2 sm:px-6 border-b border-gray-200">
          <div className="flex overflow-x-auto">
            ...
            >
              Upcoming{' '}
              <span className="ml-1 bg-blue-100 text-blue-800 text-xs px-2 rounded-full">
            ...
            >
              Active{' '}
              <span className="ml-1 bg-green-100 text-green-800 text-xs px-2 rounded-full">
                {statusCounts.active}
              </span>
            </button>
            <button
            ...
            >
              Needs Grading{' '}
              <span className="ml-1 bg-yellow-100 text-yellow-800 text-xs px-2 rounded-full">
            ...
            >
              Completed{' '}
              <span className="ml-1 bg-gray-100 text-gray-800 text-xs px-2 rounded-full">
