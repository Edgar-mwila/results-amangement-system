                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-2">
                      <Checkbox
                        id={`${role.id}-view-classes`}
                        checked={role.permissions.includes('view_classes')}
                      />
                      <Label htmlFor={`${role.id}-view-classes`}>
                        View Classes
                      </Label>

                      <Checkbox
                        id={`${role.id}-edit-grades`}
                        checked={role.permissions.includes('edit_grades')}
                      />
                      <Label htmlFor={`${role.id}-edit-grades`}>
                        Edit Grades
                      </Label>

                      <Checkbox
                        id={`${role.id}-view-students`}
                        checked={role.permissions.includes('view_students')}
                      />
                      <Label htmlFor={`${role.id}-view-students`}>
                        View Students
                      </Label>
                    </div>
                  </div>
...
export const Route = createFileRoute('/$school/dashboard/settings/')({
  component: Settings,
})
