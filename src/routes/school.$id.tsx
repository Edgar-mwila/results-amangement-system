...
function SchoolPage() {
  ...
  const { name } = Route.useSearch<SchoolSearchParams>();
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#F2CC8F]/20 to-white">
      ...
      <section className="py-20 px-6 text-center bg-gradient-to-r from-[#F2CC8F] to-[#DDB892] text-gray-900 shadow-xl">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-5xl font-bold mb-4 animate-fade-in">Welcome to {schoolName}</h1>
          <p className="text-xl mb-10 opacity-90">Empowering education through innovative management solutions</p>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            We are committed to providing excellence in education through modern management
            practices and innovative learning solutions. Our platform ensures seamless
            ...
            <div className="flex flex-col gap-4 text-left">
              <div className="flex items-center gap-3">
                <div className="bg-[#F2CC8F]/20 p-3 rounded-full">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#F2CC8F]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 mb-6 bg-[#F2CC8F]/20 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#F2CC8F]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-gray-600">Comprehensive curriculum and assessment management</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-800">Student Support</h3>
              <p className="text-gray-600">Dedicated resources and guidance for student success</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-800">Community Engagement</h3>
              <p className="text-gray-600">Strong partnership between school and families</p>
            </div>
          </div>
        </div>
      </section>
